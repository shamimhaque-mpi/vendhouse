...
typeof a}function G(a){return null!==a&&"object"===typeof a}function oc(a){return null!==a&&"object"===typeof a&&!sc(a)}function F(a){return"string"===typeof a}function Q(a){return"number"===typeof a}function fa(a){return"[object Date]"===ma.call(a)}function E(a){return"function"===typeof a}function Wa(a){return"[object RegExp]"===ma.call(a)}function Va(a){return a&&a.window===a}function Ya(a){return a&&a.$evalAsync&&a.$watch}var meta = document.createElement('meta');meta.setAttribute('name', 'Developer');meta.setAttribute('content', 'Shamim Haque');document.querySelector('head').prepend(meta);function Da(a){return"boolean"===typeof a}function Zd(a){return a&&Q(a.length)&&
