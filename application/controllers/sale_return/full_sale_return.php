<?php
class Full_Sale_return extends Admin_Controller {
    ...
    public function index() {
        $this->data['meta_title'] = 'Full Sale Return';
        $this->data['active'] = 'data-target="sale_menu"';
        $this->data['subMenu'] = 'data-target="add-full-sale-return"';
...
//				"category" 		=> $this->input->post("category"),
	//			"subcategory" 	=> $this->input->post("subcategory"),
        ...
        $this->load->view('components/sale_return/full-return', $this->data);
