...
class CurrentOrder extends Subscriber_Controller
{
...
$this->data['slider'] = $this->action->readOrderby("slider","position");
	...
	public function index(){
        ...
        $this->data['currentOrder'] = $this->action->readGroupBy('orders', 'order_no',array('mobile' => $this->data['mobile'], 'status' => 'pending'));
        ...
        $this->load->view('subscriber/currentOrder', $this->data);
