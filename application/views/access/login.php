        ...
        <section class="container">
            ...
            <div class="form-input">
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="username" placeholder="<?php echo caption('Username'); ?>" required>
                </div>

                <div class="form-group">
                    <label>Password</label>
                    <input type="password" name="password" placeholder="<?php echo caption('Password'); ?>" required>
                </div>

                <div class="form-group">
                    <label class="remember">
                        <input type="checkbox" name="remember_me" value="1"> &nbsp;
                        <?php echo caption('Remember_Me'); ?>
                    </label>
                </div>
