...
<div id="page-content-wrapper">
    ...
    <div class="row">
        <nav class="col-xs-12 content-fixed-nav">
		    ...
		    <!--ul>
                <li style="min-width: 85px;"><a class="view-site" style="font-weight: bold;" target="_blank" href="<?php //echo site_url($privilege."/dashboard?send=1"); ?>"><i class="fa fa-paper-plane-o" aria-hidden="true"></i></a></li>
            </ul-->
