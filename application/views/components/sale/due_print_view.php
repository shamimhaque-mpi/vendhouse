        ...
        <div class="panel panel-default ">
            ...
            <div class="panel-body">
                ...
                <div class="row hide">
				    ...
				    <td><span><b> Previews Paid</b></span> :&nbsp; <?php echo $totalResult[0]->prev_paid; ?> Tk</td>
				</tr>
				<tr>
					<td><span><b>Previews Due</b></span> :&nbsp; <?php echo $totalResult[0]->prev_due; ?> Tk</td>
				</tr>
		         </table>
                </div>
                ...
                <table class="table table-bordered">
                        ...
                        <tr>
                            <td>1</td>
                            <td class="text-center"><?php echo $totalResult[0]->date; ?></td>
                            <td class="text-center"><?php echo $totalResult[0]->paid; ?></td>
                            <td class="text-center"><?php echo $totalResult[0]->due; ?></td>
                            <td class="text-center"><?php echo $totalResult[0]->remission; ?></td>
                        </tr>
