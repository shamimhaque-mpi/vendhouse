<style>
    ...
    .tdNoBorder tr td{border-top: 1px dotted transparent !important;}
    ...
    .table-bordered, .table-bordered tr, .table-bordered tr th, .table-bordered tr td{border: 1px dotted #ddd !important;}
    @media print{
    ...
    .wid-150{width: 150px;}
    table tr td, table tr th{vertical-align: middle !important; font-size: 10px !important;}
</style>
    ...
    <div class="row">
        ...
        <div class="panel panel-default ">
            ...
            <div class="panel-body">
			    ...
			    <tr>
			        <td><span><b><?php echo caption('Name'); ?></b></span> :&nbsp; <?php echo $result[0]->name; ?></td>
			    </tr>
			    <tr>
			        <td><span><b>Vou</b></span> :&nbsp; <?php echo $result[0]->voucher_number; ?></td>
			    </tr>
			    <tr>
			    ...
			    <tr>
			        <td>
			            ...
			            <span><b><?php echo "সেলস ম্যান"; ?></b></span> :&nbsp; <?php echo $user_info[0]->name; ?>
			        </td>
			    </tr>
			    <tr>
			        <td><span><b><?php echo "সময়"; ?></b></span> :&nbsp; <?php echo $result[0]->time; ?></td>
			    </tr>
			</table>
			...
			<table class="table table-bordered tab1">
	                    <tr>
	                        ...
	                        <th class="text-center"><?php echo caption('Price'); ?></th>
	                        <th class="text-center">Qty</th>
	                        <th class="text-center"><?php echo caption('Amount'); ?></th>
	                    </tr>
	                    ...
	                    <?php } ?>
	                    <tr>
	                        <th rowspan="6" colspan="2"><?php echo caption('In_Word'); ?>: <span id="inword"></span> টাকা মাত্র </th>
	                    </tr>
	                    <tr>
	                     ...
	                     <tr>
	                        ...
	                        <td><?php echo $result[0]->received_amount; ?></td>
	                    </tr>
            	...
            	<div class="col-xs-12">
            	    <div class="">
            	        <table class="table topOfTable tdNoBorder tab2" style="border: 1px dotted #ddd; border-top: 2px dotted #ddd;">
			    <tr>
			...
			<table class="table table-bordered tab2">
	                    ...
	                    <?php } ?>
	                    <tr>
	                        <th rowspan="9" colspan="2"><?php echo caption('In_Word'); ?>: <span id="inword2"></span> Taka Only </th>
	                    </tr>
	                    <tr>
	                        <th class="text-right"><?php echo caption('Total'); ?></th>
