<script src="<?php echo site_url('private/js/ngscript/SupplierTransactionCtrl.js') ?>"></script>
        ...
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-5">
                        <select name="code" ng-model="code" class="selectpicker form-control"  ng-change="getCompanyInfo();"  data-show-subtext="true" data-live-search="true" required>
