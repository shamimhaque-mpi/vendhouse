...
<div class="container-fluid" ng-controller="showsubcategoryCtrl" ng-cloak>
    ...
    <div class="panel panel-default">
            <div class="panel-heading">
                <div class="panal-header-title">
                    <h1 class="pull-left"><?php echo caption('All') ; ?> <?php echo caption('Sub_Category') ; ?>  <br>  <small><?php echo $total_categori?> <?php echo caption('Item_Found'); ?> </small></h1>
            ...
            <div ng-cloak class="panel-body" ng-hide="active" ng-init="active=true;">
                ...
                <table class="table table-bordered" ng-cloak>
                    ...
                    <tr dir-paginate="subcategory in subcategorys|filter:search|itemsPerPage:perPage|orderBy:sortField:reverse">
                        <td>{{subcategory.sl}}</td>
                        <td>{{subcategory.category | textBeautify}}</td>
                        <td>{{subcategory.subcategory | textBeautify}}</td>
                        <td class="none" style="width: 110px;">
                            
                            <?php if(ck_action("subcategory","edit")){ ?>
                            <a title="Edit" class="btn btn-warning" href="<?php echo site_url('subCategory/subCategory/editsubCategory?id={{subcategory.id}}');?>" ><i class="fa fa-pencil-square-o" aria-hidden="true"></i></a>
                            <?php } ?>

                            <?php if(ck_action("subcategory","delete")){ ?>
                            <a title="Delete" class="btn btn-danger" data-id="{{subcategory.id}}" onclick="deleteAlert(`<?php echo site_url('subCategory/subCategory/deletesubCategory'); ?>/`+this.dataset.id);" href=""><i class="fa fa-trash-o" aria-hidden="true"></i></a>
                            <?php } ?>
                        </td>
                    </tr>                                    
                </table>
