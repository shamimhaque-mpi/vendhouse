        ...
        <div class="panel panel-default">
            ...
            <div class="panel-heading panal-header">
                <div class="panal-header-title pull-left">
                    <h1><?php echo caption('Add_New'); ?> <?php echo caption('Sub_Category'); ?></h1>
                </div>
            </div>
            ...
            <div class="panel-body">
	            ...
	            echo form_open('subCategory/subCategory/addsubCategory',$attr); ?>
                    ...
                    <div class="form-group">
                        <label class="col-md-2 control-label"><?php echo caption('Sub_Category'); ?> <span class="req">*</span></label>
