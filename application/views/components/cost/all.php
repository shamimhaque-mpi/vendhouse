                ...
                <table class="table table-bordered">
                    ...
                    <tr>
                        ...
                        <td class="none text-center " style="width: 110px;">
                            ...
                            <a title="Delete" class="btn btn-danger" onclick="deleteAlert(`<?php echo site_url('cost/cost/delete_cost/'.$value->id);?>`);" href="" ><i class="fa fa-trash-o" aria-hidden="true"></i></a>
                        </td>
                    </tr>
