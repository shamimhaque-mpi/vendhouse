...
<div class="container-fluid">
    <div class="row">
	    ...
	    <?php if(isset($allOrder[0])){ ?>
        <div class="panel panel-default">
            <div class="panel-heading panal-header">
                <div class="panal-header-title">
                    <h1 class="pull-left">SR Report</h1>
            ...
            <div class="panel-body">
                ...
                <table class="table table-bordered order-table" >
                    ...
                    foreach($allOrder as $key => $value){
                        ...
                        if(isset($supplierInfo[0])){
                        if($supplierInfo[0]->sr != null || $supplierInfo[0]->sr != ''){
                            $srCommission = $value->grand_total*.1;
                            $srInfo = $this->action->read('sr', array('code' => $supplierInfo[0]->sr));
                    ...
                    <tr>
                        ...
                        <td><?php echo filter($srInfo[0]->name); ?></td>
                        <td><?php echo $value->order_no; ?></td>
                        <td><?php echo $value->grand_total; ?></td>
                        <td><?php echo $value->discount; ?></td>
                        <td><?php echo $srCommission; ?></td>
                    </tr>
                    <?php } } }else{$srCommission = 0.00;} } ?>
                    <tr>
