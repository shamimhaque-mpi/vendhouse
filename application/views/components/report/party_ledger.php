        ...
        <div class="panel panel-default">
            ...
            <div class="panel-heading">
                <div class="panal-header-title pull-left">
                    <h1><?php echo caption('Party_Ledger'); ?></h1>
                </div>
            </div>
            ...
            <div class="panel-body none">
                ...
                <div class="row">
                    ...
                    <div class="form-group">
                        <label class="col-md-2 control-label"><?php echo caption('Supplier'); ?><span class="req">*</span></label>
                        <div class="col-md-5" >
                ...
                <div class="row hide">
                    ...
                    <div class="table-responsive">
                        ...
                        <tr style="font-weight: bold;">
                            <td colspan="3" class="text-right"><?php echo caption('Total'); ?></td>
