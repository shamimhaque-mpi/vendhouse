        ...
        <div class="panel panel-default none">
            ...
            <div class="panel-heading">
                <div class="panal-header-title pull-left">
                    <h1>Supplier Wise Free Products</h1>
                </div>
            </div>
            ...
            <div class="panel-body">
                ...
                ?>
                    ...
                    <div class="form-group">
                        <label class="col-md-2 control-label">Supplier<span class="req"> *</span></label>
                        <div class="col-md-4">
        ...
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                ...
                <div class="row hide">
                    ...
                    <h5 class="text-center">Supplier Wise Free Products</h5>
                </div>

                <hr class="hide" style="border-bottom: 2px solid #ccc; margin-top: 5px;">
                <h5 class="text-center hide">
                    Supplier Name : 
                    <?php 
                      $supplier = $this->action->read("parties",array("id" => $_POST['supplier']));
                      echo ($supplier) ? filter($supplier[0]->name) : "";
                    ?>
                </h5>
                ...
                <table class="table table-bordered table2">
                    ...
                    <?php 
                      ...
                      $info = $this->action->read("purchase",array("vendor_id" => $_POST['supplier'],"product_code" => $value->code));
                      if($info != NULL){ ?>
                        <tr>
