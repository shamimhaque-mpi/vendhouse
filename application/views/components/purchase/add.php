<!--<script src="<?php echo site_url('private/js/ngscript/PurchaseEntry.js') ?>"></script>-->
        ...
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                ...
                <div class="row new-row-1">
                    ...
                    <div class="col-md-2">
                        <input type="text" name="voucher_no" placeholder="Voucher No" class="form-control" required ng-class="{'red': validation}" ng-model="voucherNo" ng-change="exists()">
                    </div>
                    <div class="col-md-2">
                ...
                <table class="table table-bordered table2">
                    ...
                    <tr ng-repeat="item in cart">
                        ...
                        <td>
                            ...
                            <input type="hidden" name="product_cat[]" value="{{ item.product_cat }}">
                            <input type="hidden" name="product_subcat[]" value="{{ item.product_subcat }}">
