    ...
    <div class="row">
        ...
        <div class="panel panel-default">
            ...
            <div class="panel-body" ng-cloak>
                ...
                echo form_open('purchase/returnPurchase?vno=' . $this->input->get('vno'), $attr);
                ?>
                ...
                <div class="col-md-4">
                    <div class="input-group date" id="datetimepicker">
                        <input type="text" name="date" class="form-control" value="<?php echo $date; ?>" placeholder="Date" readonly>
                ...
                <table class="table table-bordered table2">
                    <tr>
                        ...
                        <th class="th-width">Return Quantity</th>
                        <th class="th-width">Old Sum</th>
                        <th class="th-width">Return Sum</th>
                    </tr>
                    <tr ng-repeat="item in records">
                        ...
                        <td>
                            <input type="number" name="purchase_price[]" class="form-control" min="0" ng-model="item.purchase_price" step="any" readonly>
                        </td>
                        <td>
                            <input type="number" name="old_quantity[]" class="form-control" ng-model="item.oldQuantity" readonly>
                        </td>
                        <td>
                            <input type="number" name="return_quanity[]" class="form-control" min="0" ng-model="item.newQuantity" max="{{ item.maxQuantity}}">
                        </td>
                        <td>
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="btn-group pull-right">
                            <input type="submit" name="change" value="Return" class="btn btn-info">
                        </div>
                    </div>
                </div>
                <?php echo form_close(); ?>
